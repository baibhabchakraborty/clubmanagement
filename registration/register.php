		...
		<div class="module">
			...
			?>
				...
				<p id="clubname-err"></p>
				 ...
				 <input type="text" placeholder="University ID" id="username" name="username">
				<p id="username-err"></p>
				 ...
				 <p id="dept-err"></p>
				  ...
				  <b>Semester :</b>
				  <input type="radio" name="semester" value="first" checked>1
				  <input type="radio" name="semester" value="second">2
				  <input type="radio" name="semester" value="third">3
				  <input type="radio" name="semester" value="fourth">4
				  <input type="radio" name="semester" value="fifth">5
				  <input type="radio" name="semester" value="sixth">6
				  <input type="radio" name="semester" value="seventh">7
				  <input type="radio" name="semester" value="eighth">8
				<br><br>
				<b>Gender : </b>
